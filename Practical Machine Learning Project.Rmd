...
In sample error = (1 - accuracy) x 100. For random forest model, the accuracy is 99.86%, therefore its in sample error is (1 - 0.9986) x 100 = 0.14%.
...
The estimated out of sample error of random forest model is 0.14%. Normally, the out of sample error is greater than the in sample error. However, the random forest model built in this project shows comparable out of sample error and in sample error, indicating there is no overfitting. 
